...
#Buttons
button1 = Button(root, text='Calendar', command=calendar, bg="lightgreen", width=12)
button1.place(x=30, y=110)

button2 = Button(root, text='Buildings', command=building, bg="lightgreen", width=12)
button2.place(x=150, y=110)

button3 = Button(root, text='Faculty', command=faculty, bg="lightgreen", width=12)
